			...
			<div class="eXtremeTable">
				<table id="ec_table" class="tableRegion" width="98%">
					...
					<tr class="odd">
						<td>入职日期:</td>
						<td>
							<!-- <input type="text" name="userInfo.joinDate" /> --> <input
							type="text" style="width: 110px;" name="userInfo.joinDate"
					...
					<tr class="odd">
						...
						<td><input type="radio" name="userInfo.gender" value="男" />男
							<input type="radio" name="userInfo.gender" value="女" />女 <input
							type="radio" name="userInfo.gender" value="其他" />其它</td>
					</tr>
					<tr class="odd">
						<td>岗位描述:</td>
					...
					<tr class="odd">
						...
						<td colspan="3"><textarea style="height: 80px; width: 90%"
								name="userInfo.remark"></textarea></td>
					</tr>
				</table>
			</div>
